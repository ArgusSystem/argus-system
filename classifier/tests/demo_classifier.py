...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        print("")
        print("Usage: ")
        print("python demo_classifier.py 'embeddings_filename'")
        print("Or: ")
        print("python demo_classifier.py 'embeddings_filename' min_nrof_images_per_class nrof_train_images_per_class")
        print("--------------------------------")
