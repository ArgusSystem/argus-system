...
config = edict()
# This disables the use of GPU. Set it to 0 or an appropriate device id to enable GPU usage.
...
try:
    from detector.src.faceboxes.core.model.facebox.anchor_generator import AnchorGenerator
except:
